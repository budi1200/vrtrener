...
<html>
	...
	<body>
		<div class="SlideShow" style="max-width:500px">
			<img class="mySlides" src="nature1.jpg" width="100%">
			<img class="mySlides" src="nature2.jpg" width="100%">
			<img class="mySlides" src="nature3.jpg" width="100%">
		</div>
		<table>
		<script>SlideShow()</script>
			</tr>
			<tr>
				<td colspan="2"><img src="slike_prva_stran/logo.png" alt="logo" width="225" height="200"></td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td id="td_vr_logo" colspan="2">
					<!-- <a href="vr/index.php"><img src="slike_prva_stran/vr_logo.png" alt="vr_logo" height="80px" width="100px"></a> -->
